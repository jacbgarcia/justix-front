...
const MediacoesListFeed = () => {
    ...
    const fetchComments = async () => {
        try {
            const res = await axios.get(`https://justix-back.vercel.app/av_mediador/${id_mediador}`);
    ...
    const fetchAverageRating = async () => {
        try {
            const res = await axios.get(`https://justix-back.vercel.app/mediador_avaliacao/${id_mediador}`);
