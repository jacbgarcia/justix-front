...
const TribunaisListFeed = () => {
    ...
    const fetchComments = async () => {
        try {
            const res = await axios.get(`https://justix-back.vercel.app/av_tribunais/${id_tribunal}`);
    ...
    const fetchAverageRating = async () => {
        try {
            const res = await axios.get(`https://justix-back.vercel.app/tribunais_avaliacao/${id_tribunal}`);
