...
const AdvocaciaForm = ({ id_advocacia, onCommentAdded }) => {
    ...
    const handleSubmitComment = async (e) => {
        ...
        try {
            const response = await axios.post('https://justix-back.vercel.app/av_advocacia', formData);
