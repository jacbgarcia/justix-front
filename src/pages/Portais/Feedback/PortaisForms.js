...
import PortaisFormFeed from '../../../components/BDPages/Feedbacks/PortaisFormFeed';
...
const PortaisFormPage = () => {
  const { id_portal } = useParams(); // Obtém o id_forum da URL
  ...
  }, [id_portal]); // Dependência para refazer a busca quando o id_forum mudar
  ...
  return (
    <>
      ...
      <div>
        <PortaisFormFeed id_portal={id_portal} fetchComments={fetchComments} />
      </div>
      <Footer />
    </>
  );
