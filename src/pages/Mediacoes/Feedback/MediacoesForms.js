...
import MediacoesFormFeed from '../../../components/BDPages/Feedbacks/MediacoesFormFeed';
...
const MediacoesFormPage = () => {
  const { id_mediador } = useParams(); // Obtém o id_forum da URL
  ...
  }, [id_mediador]); // Dependência para refazer a busca quando o id_forum mudar
  ...
  return (
    <>
      ...
      <div>
        <MediacoesFormFeed id_mediador={id_mediador} fetchComments={fetchComments} />
      </div>
      <Footer />
    </>
  );
