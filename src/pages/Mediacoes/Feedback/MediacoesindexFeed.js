...
const MediacoesindexFeed = () => {
  ...
  return (
    <>
      ...
      <ContainerLggd><Link to="/user/dashboard/mediacoes" className={style.backButton}>← Voltar</Link>
...
export default MediacoesindexFeed;
