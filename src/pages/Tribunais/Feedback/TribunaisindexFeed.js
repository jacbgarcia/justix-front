...
const TribunaisindexFeed = () => {
  ...
  return (
    <>
      ...
      <ContainerLggd><Link to="/user/dashboard/tribunais" className={style.backButton}>← Voltar</Link>
...
export default TribunaisindexFeed;
