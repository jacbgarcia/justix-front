// src/pages/Audiencias/AudienciasListPage.js
import React, { useState, useEffect } from 'react';
import { useNavigate, Link } from 'react-router-dom';
import AudienciasListFeed from '../../../components/BDPages/Feedbacks/AudienciasListFeed';
import HeaderLggd from '../../../components/HeaderLggd';
import Footer from '../../../components/Footer';
import ContainerLggd from '../../../components/ContainerLggd';
import style from '../../../components/Card/Card.module.css';

const AudienciasindexFeed = () => {
  ...
  return (
    <>
      ...
      <ContainerLggd><Link to="/user/dashboard/audiencias" className={style.backButton}>← Voltar</Link>
...
export default AudienciasindexFeed;
